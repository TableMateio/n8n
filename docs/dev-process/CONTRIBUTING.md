...
The project uses a standardized directory structure for organizing workflows:
...
For more information on our workflow structure and naming conventions, please refer to the `workflows/README.md` file.
